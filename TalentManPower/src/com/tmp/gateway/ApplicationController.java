...
public class ApplicationController extends HttpServlet implements Servlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println(" Action is (in application controller servlet) " + userAction);
		Users usr=null;
		...
		switch(userAction) {
			...
			case  "loginUser" :
				...
				try{
					...
					e.printStackTrace();
					System.out.println("Exception at login user case of appication controller");
					returnPath="/views/errorPage.jsp";
				}
				break;
				
			case "loadCourses" :
				System.out.println("loading courses..(In application controller)");
				...
				try{				
					...
					h.printStackTrace();
					System.out.println("Error in getting the list of courses..!!");
					returnPath="/views/errorPage.jsp";
				}
			...
			case "trainCompanyForm":
				System.out.println("trainCompanyform inside application controller");
				...
				try{
					...
					System.out.println("Exception in parsing the contact no");
				}
				System.out.println("company name"+cname+" company email id"+cemail+" company contact no"+contact);
				try{
			...
			case "employeeSignUpJobForm" :
				System.out.println("employeeSignUpJobForm inside application controller");	
				...
				else
				{
					...
					try{
						...
						p.printStackTrace();
						System.out.println("Exception occured at employee sign up form in application controller");
					}
			...
			case "veForm":
				...
				if (!captcha.equals(code)){
					...
					try{
						...
						System.out.println("mail exceotion of ve form in application controller");
					};
				}	
			...
			case "changePwd" :
				...
				try{	
					...
					e.printStackTrace();
					System.out.println("Exception at change password case of appication controller");
					returnPath="/views/errorPage.jsp";
				}
				break;		
		default:
